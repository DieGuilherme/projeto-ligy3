...
if uploaded_file:
    ...
    df_temp["economia_percebida"] = np.where(np.where(df_temp["s_ligy"] == 0, 0, df_temp["economia_real"]/df_temp["s_ligy"]) == 'nan', 0, np.where(df_temp["s_ligy"] == 0, 0, df_temp["economia_real"]/df_temp["s_ligy"])) + '%'
